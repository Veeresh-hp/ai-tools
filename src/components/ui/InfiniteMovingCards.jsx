    ...
    >
      <ul
        ...
        style={{
            ...
            animationDelay: "-20s", // Start from the "3rd card" (halfway) offset
        }}
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-700 px-8 py-6 md:w-[450px] shadow-2xl"
            style={{
              background: "#f97316",
              borderColor: "rgba(255,255,255,0.1)",
            }}
            key={item.name + idx} // Using name+idx because we duplicate logic handles DOM nodes, but React needs unique keys for initial render.
          >
            <blockquote>
              <div
                aria-hidden="true"
